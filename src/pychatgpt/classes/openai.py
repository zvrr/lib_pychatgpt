...
class Auth:
    ...
    def create_token(self):
        ...
        if not self.email_address or not self.password:
            print(
                f"{Fore.RED}[OpenAI] {Fore.WHITE}Please provide an email address and password"
            )
            ...
            print(
                f"{Fore.GREEN}[OpenAI] {Fore.WHITE}Email address: {self.email_address}"
            )
            # Show 3 characters of password, then hide the rest
            print(
                f"{Fore.GREEN}[OpenAI] {Fore.WHITE}Password: {self.password[:3]}{'*' * len(self.password[3:])}"
            )
        ...
        if response.status_code == 200:
            print(
                f"{Fore.GREEN}[OpenAI][1] {Fore.WHITE}Request was "
                + Fore.GREEN
                + "successful"
            )
            self._part_two()
    ...
    def _part_two(self):
        ...
        if response.status_code == 200 and "json" in response.headers["Content-Type"]:
            print(
                f"{Fore.GREEN}[OpenAI][2] {Fore.WHITE}Request was "
                + Fore.GREEN
                + "successful"
            )
            ...
            raise Exceptions.Auth0Exception(
                "[OpenAI][2] Failed to make the request, Try that again!"
            )
    ...
    def _part_three(self, token: str):
        ...
        if response.status_code == 200 and "json" in response.headers["Content-Type"]:
            print(
                f"{Fore.GREEN}[OpenAI][3] {Fore.WHITE}Request was "
                + Fore.GREEN
                + "successful"
            )
            ...
            if (
                ...
                print(
                    f"{Fore.GREEN}[OpenAI][3] {Fore.WHITE}Error: "
                    + Fore.RED
            ...
            raise Exceptions.IPAddressRateLimitException(
                "[OpenAI][3] Bad request from your IP address, "
                "try again in a few minutes"
            )
        else:
            raise Exceptions.Auth0Exception(
                "[OpenAI][3] Failed to make the request, Try that again!"
            )
    ...
    def _part_four(self, url: str):
        ...
        if response.status_code == 302:
            print(
                f"{Fore.GREEN}[OpenAI][4] {Fore.WHITE}Request was "
                + Fore.GREEN
                + "successful"
            )
            ...
            raise Exceptions.Auth0Exception(
                "[OpenAI][4] Failed to make the request, Try that again!"
            )
    ...
    def _part_five(self, state: str):
        ...
        if response.status_code == 200:
            print(
                f"{Fore.GREEN}[OpenAI][5] {Fore.WHITE}Request was "
                + Fore.GREEN
                + "successful"
            )
            ...
            if soup.find("img", alt="captcha"):
                ...
                print(
                    f"{Fore.GREEN}[OpenAI][5] {Fore.WHITE}Captcha saved to {Fore.GREEN}captcha.png"
                ...
                if captcha_input:
                    ...
                    raise Exceptions.PyChatGPTException(
                        "[OpenAI][5] You didn't enter anything."
                    )
            ...
            raise Exceptions.Auth0Exception(
                "[OpenAI][5] Failed to make the request, Try that again!"
            )
    ...
    def _part_six(self, state: str, captcha: str or None):
        ...
        """
        print(
            f"{Fore.GREEN}[OpenAI][6] {Fore.WHITE}Making request to https://auth0.openai.com/u/login/identifier"
        )
        url = f"https://auth0.openai.com/u/login/identifier?state={state}"
        ...
        if response.status_code == 302:
            ...
            raise Exceptions.Auth0Exception(
                "[OpenAI][6] Email not found, Check your email address and try again!"
            )
    ...
    def _part_seven(self, state: str):
        ...
        if is_302:
            print(
                f"{Fore.GREEN}[OpenAI][7] {Fore.WHITE}Password was "
                + Fore.GREEN
                + "correct"
            )
            ...
            print(
                f"{Fore.GREEN}[OpenAI][7] {Fore.WHITE}New State: {Fore.GREEN}{new_state}"
            )
            self._part_eight(old_state=state, new_state=new_state)
        else:
            raise Exceptions.Auth0Exception(
                "[OpenAI][7] Password was incorrect or captcha was wrong"
            )

    def _part_eight(self, old_state: str, new_state):
        url = f"https://auth0.openai.com/authorize/resume?state={new_state}"
        print(
            f"{Fore.GREEN}[OpenAI][8] {Fore.WHITE}Making request to {Fore.GREEN}{url}"
        )
        headers = {
            "Host": "auth0.openai.com",
            "Accept": "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8",
        ...
        if is_200:
            ...
            if access_token:
                ...
                print(
                    f"{Fore.GREEN}[OpenAI][8] {Fore.WHITE}Access Token: {Fore.GREEN}{access_token}"
                )
                # Save access_token
                self.save_access_token(access_token=access_token)
            else:
                print(
                    f"{Fore.GREEN}[OpenAI][8][CRITICAL] {Fore.WHITE}Access Token: {Fore.RED}Not found"
    ...
    def part_nine(self):
        print(
            f"{Fore.GREEN}[OpenAI][9] {Fore.WHITE}"
        ...
        if is_200:
            ...
            if "json" in response.headers["Content-Type"]:
                ...
                print(
                    f"{Fore.GREEN}[OpenAI][9] {Fore.WHITE}Access Token: {Fore.GREEN}{access_token}"
                )
                self.save_access_token(access_token=access_token)
            else:
                print(
                    f"{Fore.GREEN}[OpenAI][9] {Fore.WHITE}Access Token: {Fore.RED}Not found, "
